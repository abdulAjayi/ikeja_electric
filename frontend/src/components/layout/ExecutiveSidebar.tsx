...
const EXEC_NAV_ITEMS: NavItem[] = [
  { label: "Cost Overview", to: "/executive/cost-overview", icon: DollarSign },
  { label: "Sustainability / ESG", to: "/executive/sustainability", icon: Leaf },
  { label: "Peak Demand", to: "/executive/peak-demand", icon: Zap },
  { label: "Benchmarking", to: "/executive/benchmarking", icon: BarChart3 },
];
  ...
  const sidebarContent = (
    <div className="h-full flex flex-col justify-between bg-[#1F2937] text-white select-none">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 space-y-6">
        ...
        {/* Main Nav Section */}
        <nav aria-label="Executive Navigation" className="space-y-1">
          {EXEC_NAV_ITEMS.map((item) => {
